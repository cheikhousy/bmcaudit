...
if (function_exists('vc_map')) {
    vc_map(array(
        ...
        'name' => esc_html__('Blog Posts', 'brainbizz'),
        ...
        'params' => array(
            ...
            array(
                'type' => 'textfield',
                'heading' => esc_html__('Read More Text', 'brainbizz'),
                'param_name' => 'read_more_text',
                'edit_field_class' => 'vc_col-sm-8',
                'value' => 'Read More',
                'description' => esc_html__( 'Enter read more text.', 'brainbizz' ),
                'dependency' => array(
            ...
            array(
                'type' => 'brainbizz_param_heading',
                'heading' => esc_html__('Blog Meta Styles', 'brainbizz'),
                'group' => esc_html__( 'Custom', 'brainbizz' ),
                'edit_field_class' => 'vc_col-sm-12',
            ...
            array(
                'type' => 'wgl_checkbox',
                'heading' => esc_html__( 'Custom font family for Blog Meta Info', 'brainbizz' ),
            ...
            array(
                'type' => 'wgl_checkbox',
                'heading' => esc_html__( 'Custom font size for Blog Meta Info', 'brainbizz' ),
            ...
            array(
                ...
                'description' => esc_html__( 'Custom blog meta info color.', 'brainbizz' ),
                'group' => esc_html__( 'Custom', 'brainbizz' ),
                'edit_field_class' => 'vc_col-sm-7',
            ),
            // Custom blog style
            ...
            array(
                'type' => 'brainbizz_param_heading',
                'heading' => esc_html__('Media Styles', 'brainbizz'),
                'group' => esc_html__( 'Custom', 'brainbizz' ),
                'edit_field_class' => 'vc_col-sm-12',
                'param_name' => 'blog_content_styles',
            ),
    ...
    BrainBizz_Loop_Settings::init('wgl_blog_posts_standard');
