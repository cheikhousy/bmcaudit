...
if ( ! function_exists( 'brainbizz_woocommerce_breadcrumb' ) ) {
	...
	function brainbizz_woocommerce_breadcrumb( $args = array() ) {
		...
		if ( ! empty( $breadcrumb ) ) {
			...
			echo BrainBizz_Theme_Helper::render_html($wrap_before);

			foreach ( $breadcrumb as $key => $crumb ) {

				echo BrainBizz_Theme_Helper::render_html($before);
				...
				echo BrainBizz_Theme_Helper::render_html($after);

				if ( sizeof( $breadcrumb ) !== $key + 1 ) {
					echo BrainBizz_Theme_Helper::render_html($delimiter);
				}
			}
			echo BrainBizz_Theme_Helper::render_html($wrap_after);
		}
