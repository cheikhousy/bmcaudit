...
if (!class_exists('WglAdminIcon')) {
    class WglAdminIcon {
        ...
        private function parse_args() {
            $this->wp_remote_get_args = apply_filters( 'brainbizz_wp_remote_get_args', $this->wp_remote_get_args );
        }
        ...
        private function set_css_transient( $version, $value ) {
            ...
            $transient_expiration = apply_filters( 'brainbizz_css_transient_expiration', 30 * DAY_IN_SECONDS );
        ...
        private function setup_icon_array( $css ) {
            ...
            asort( $icons );
            $icons = apply_filters( 'brainbizz_icon_list', $icons );
            return $icons;
        } 
        ...
        public function enqueue_admin_scripts() {
            ...
            $brainbizz_vars = array(
                'fa_prefix'   => $this->prefix,
                'fa_icons'    => $this->get_icons(),
            );

            wp_localize_script( 'wgl-admin', 'brainbizz_vars', $brainbizz_vars );
        ...
        public function add_insert_shortcode_button() {
            ...
            <span class="wgl-iconpicker fontawesome-iconpicker" data-selected="fa-flag">
                <a href="#" class="button button-secondary iconpicker-component">
                    ...
                    <?php esc_html_e( 'Insert Icon', 'brainbizz' ); ?>
