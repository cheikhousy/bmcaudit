...
if (!class_exists('BrainBizz_header_sticky')) {
	class BrainBizz_header_sticky extends BrainBizz_get_header{

		public function __construct(){
			$this->header_vars();  
			$this->html_render = 'sticky';

	   		if (BrainBizz_Theme_Helper::options_compare('header_sticky','mb_customize_header_layout','custom') == '1') {
	   			$header_sticky_style = BrainBizz_Theme_Helper::get_option('header_sticky_style');
	   			$header_sticky_background = BrainBizz_Theme_Helper::get_option('header_sticky_background');
	   			$header_sticky_color = BrainBizz_Theme_Helper::get_option('header_sticky_color');
	   			$header_sticky_border = BrainBizz_Theme_Helper::get_option('header_sticky_border');
	   			$header_sticky_border_height = BrainBizz_Theme_Helper::get_option('header_sticky_border_height');
	   			$header_sticky_border_color = BrainBizz_Theme_Helper::get_option('header_sticky_border_color');
	   			$header_sticky_shadow = BrainBizz_Theme_Helper::get_option('header_sticky_shadow');
