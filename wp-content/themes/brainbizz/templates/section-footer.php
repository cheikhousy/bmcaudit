...
if (!class_exists('BrainBizz_footer_area')) {
	/**
	 * Footer area
	 *
	 *
	 * @class 		BrainBizz_footer_area
	 * @version		1.0
	 * @category	Class
	 * @author 		WebGeniusLab
	 */
    ...
    class BrainBizz_footer_area {
		...
		*/  	
    	...
    	function __construct () {
	        ...
	        $footer_bg_color = BrainBizz_Theme_Helper::get_option('footer_bg_color');
	        // copyright option
	        $copyright_switch = BrainBizz_Theme_Helper::get_option('copyright_switch');
			
			//add global variables
	        $this->footer_full_width = BrainBizz_Theme_Helper::get_option('footer_full_width');
	        ...
	        $style .= BrainBizz_Theme_Helper::bg_render('footer','mb_footer_switch','on');
	        ...
	        */
	        if ($footer_switch || $copyright_switch) {
	            echo "<footer class='footer clearfix'".$style." id='footer'>";
	                if ($footer_switch) {
	                	$footer_content_type = BrainBizz_Theme_Helper::options_compare('footer_content_type','mb_footer_switch','on');
    	...
    	private function get_wave_html(){
    		$wave_switch = BrainBizz_Theme_Helper::options_compare('footer_add_wave','mb_footer_switch','on');
    		if((bool) $wave_switch){

    			$wave_height = BrainBizz_Theme_Helper::get_option('footer_wave_height');
    			...
    			echo "<div class='brainbizz_wave_footer' style='height:".(int) $wave_height."px;'>";
    	...
    	private function get_footer_vars($optn_1 = null){
    		...
    		//Get options	
			$footer_spacing = BrainBizz_Theme_Helper::options_compare('footer_spacing','mb_footer_switch','on');

	        // Only for widgets in footer
	        if ($optn_1 == 'widgets') {
				$footer_options['widget_columns'] = BrainBizz_Theme_Helper::get_option('widget_columns');
		        $footer_options['widget_columns_2'] = BrainBizz_Theme_Helper::get_option('widget_columns_2');
		        $footer_options['widget_columns_3'] = BrainBizz_Theme_Helper::get_option('widget_columns_3');
		        $footer_align = BrainBizz_Theme_Helper::get_option('footer_align');
    	...
    	private function main_footer_get_page(){
	        ...
	        echo "<div class='footer_top-area'>";
                ...
                echo "<div class='row-footer'".$footer_style.">";
                    ...
                    $footer_page_select = BrainBizz_Theme_Helper::options_compare('footer_page_select','mb_footer_switch','on');
    	...
    	private function copyright_spacing(){
	        //Get options
    		$copyright_spacing = BrainBizz_Theme_Helper::options_compare('copyright_spacing','mb_copyright_switch','on');
    	...
    	private function copyright_style(){
			$bg_color = BrainBizz_Theme_Helper::options_compare('copyright_bg_color','mb_copyright_switch','on');
    	...
    	private function copyright_html() {	
	        $editor = BrainBizz_Theme_Helper::get_option('copyright_editor');

	        if ($this->mb_copyright_switch == 'on') {
	        	$editor = rwmb_meta('mb_copyright_editor');
	        }
	        ?>
    		<div class='copyright'<?php echo BrainBizz_Theme_Helper::render_html($this->copyright_style()); ?> >
                <?php if (!$this->footer_full_width) echo "<div class='wgl-container'>"; ?>
                	<div class='row' <?php echo BrainBizz_Theme_Helper::render_html($this->copyright_spacing());?> >
